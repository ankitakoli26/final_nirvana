    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4"
      ...
      <div className="relative z-10 w-full max-w-[460px]">
        ...
        <motion.div className="text-center mb-8"
          ...
          <motion.h1 className="text-5xl font-black mb-1"
        ...
        <motion.div className="text-center mb-8"
          ...
          <p style={{ color:'rgba(255,255,255,0.4)', fontSize:'14px' }}>Track · Reflect · Heal · Grow · Thrive</p>
        </motion.div>
        ...
        <motion.div
          ...
          style={{ background:'rgba(255,255,255,0.05)', border:'1px solid rgba(255,255,255,0.12)', backdropFilter:'blur(40px)', boxShadow:'0 40px 80px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.1)' }}
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="text-xl font-bold text-white" style={{ fontFamily:'Poppins,sans-serif' }}>Welcome back</h3>
          </div>
          ...
          <AnimatePresence>
            {error && (
              <motion.div className="mb-5 px-4 py-3 rounded-xl text-sm"
          ...
          <form onSubmit={handleLogin}>
            <div className="mb-4">
              <label className="block text-xs font-semibold mb-2 uppercase tracking-widest"
                style={{ color:'rgba(168,216,200,0.7)' }}>Email address</label>
            ...
            <div className="mb-8">
              <label className="block text-xs font-semibold mb-2 uppercase tracking-widest"
                style={{ color:'rgba(168,216,200,0.7)' }}>Password</label>
              <div className="relative">
            ...
            <motion.button type="submit" disabled={loading}
              ...
              style={{ background:'linear-gradient(135deg, #2E8B57 0%, #3AAFA9 50%, #7C3AED 100%)', boxShadow:'0 8px 30px rgba(124,58,237,0.35)', cursor:loading ? 'not-allowed' : 'pointer', opacity:loading ? 0.8 : 1, fontFamily:'Poppins,sans-serif' }}
        ...
        <motion.div className="text-center mt-6"
         ...
         <p className="text-xs mb-3" style={{ color:'rgba(255,255,255,0.55)' }}>
          ...
          <p className="text-xs mb-2" style={{ color:'rgba(255,255,255,0.55)' }}>Made with 💚 by</p>
          <div className="flex items-center justify-center gap-4">
            <a href="https://github.com/ankitakoli26" target="_blank" rel="noopener noreferrer"
              className="px-3 py-1.5 rounded-lg text-xs transition-all"
              style={{ background:'rgba(255,255,255,0.1)', border:'1px solid rgba(255,255,255,0.25)', color:'rgba(255,255,255,0.75)' }}
              onMouseEnter={e => { e.currentTarget.style.background='rgba(46,139,87,0.3)'; e.currentTarget.style.color='#a8d8c8' }}
            ...
            <a href="https://github.com/apurvaKhade25" target="_blank" rel="noopener noreferrer"
              className="px-3 py-1.5 rounded-lg text-xs transition-all"
              style={{ background:'rgba(255,255,255,0.1)', border:'1px solid rgba(255,255,255,0.25)', color:'rgba(255,255,255,0.75)' }}
              onMouseEnter={e => { e.currentTarget.style.background='rgba(124,58,237,0.3)'; e.currentTarget.style.color='#D9C7FF' }}
              onMouseLeave={e => { e.currentTarget.style.background='rgba(255,255,255,0.1)'; e.currentTarget.style.color='rgba(255,255,255,0.75)' }}>
              🐙 Apurva Khade
            </a>
          </div>
